...
def account():
    ...
    if form.validate_on_submit():
        ...
        db.session.commit()
        flash('your accout has benn updated', 'success')
...
def user_posts(username):
    ...
    return render_template('user_post.html', postes=posts, user=user)
...
def reset_request():
    ...
    if form.validate_on_submit():
        ...
        flash('An email have been sent to reset password', 'info')
        return redirect(url_for('users.login'))
